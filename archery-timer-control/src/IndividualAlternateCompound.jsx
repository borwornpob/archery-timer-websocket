...
export default function IndividualAlternateCompound() {
    function updateData() {
        console.log(data);
    ...
    return (
        <VStack spacing={4}>
            <Heading>Individual Alternate Compound</Heading>
            ...
            <HStack spacing={4}>
                <VStack spacing={4}>
                    <Text>Left Total Points</Text>
                    <NumberInput
                        value={data.total_left}
                        onChange={(value) =>
                            setData({
                                ...data,
                                total_left: value,
                    ...
                    >
                        <NumberInputField placeholder="Left Total Points" />
                    </NumberInput>
                </VStack>
                <VStack spacing={4}>
                    <Text>Right Total Points</Text>
                    <NumberInput
                        value={data.total_right}
                        onChange={(value) =>
                            setData({
                                ...data,
                                total_right: value,
                    ...
                    >
                        <NumberInputField placeholder="Right Total Points" />
                    </NumberInput>
                </VStack>
            </HStack>
            <HStack spacing={4}>
